...
export const ContactUs = () => {
    ...
    return (
        <div className="container mx-auto pt-16 dark:bg-slate-900">
            <div className="lg:flex">
                ...
                <div className="xl:w-3/5 lg:w-3/5 bg-gray-200 h-full pt-5 pb-5 xl:pr-5 xl:pl-0 rounded-tr rounded-br dark:bg-slate-700 ">
                    <form ref={form} onSubmit={sendEmail}  id="contact" className="bg-white py-4 px-8 rounded-tr rounded-br dark:bg-slate-800 " >
                        ...
                        <div className="flex w-full flex-wrap">
                            <div className="w-2/4 max-w-xs">
                                <div className="flex flex-col">
                                    <label htmlFor="phone" className="text-gray-800 text-sm font-semibold leading-tight tracking-normal mb-2 dark:text-gray-200">
                                        Subject
                                    </label>
                        ...
                        <div className="w-full mt-6">
                            <div className="flex flex-col">
                                ...
                                <textarea placeholder name="message" className="border-gray-300 border mb-4 rounded py-2 text-sm outline-none resize-none px-3 focus:border focus:border-indigo-700 dark:bg-slate-900 " rows={8} id="message" defaultValue={""} />
                            </div>
